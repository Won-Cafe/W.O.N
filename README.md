...
```mermaid
flowchart LR
    WHAT(["<b>WHAT</b><br/>thực tại bạn đứng"])
    OWN(["<b>OWN</b><br/>cái thuộc về bạn"])
    NEED(["<b>NEED</b><br/>phương tiện bạn cần"])
    WHAT --> OWN --> NEED -->|mỗi vòng sâu hơn| WHAT
```
...
flowchart TD
    ...
    OWN(["<b>OWN</b><br/>cái thuộc về bạn"])
    NEED(["<b>NEED</b><br/>phương tiện bạn cần"])
    WHAT -->|"Sự tỉnh thức"| OWN
    OWN -->|"Sự hành động"| NEED
    NEED -->|"Sự thích nghi"| WHAT
```
...
```mermaid
flowchart TD
    YOU(["<b>Bạn</b><br/>ý định"]) <--> TZU["<b>đệ Tzu</b><br/>điều phối"]
    TZU --> SUN["<b>đệ Sun</b><br/>trinh sát"]
    TZU --> MO["<b>đệ Mo</b><br/>kiến trúc"]
    TZU --> FAN["<b>đệ Fan</b><br/>kế hoạch"]
    TZU --> HAN["<b>đệ Han</b><br/>kiểm chất"]
    TZU --> SHU["<b>đệ Shu</b><br/>biên ghi"]
```
...
```mermaid
flowchart LR
    S(["mỗi phiên"]) --> F["<b>working/</b><br/>bộ nhớ làm việc"]
    S --> M["<b>moments/</b><br/>ký ức ngắn hạn"]
    subgraph LT ["ký ức dài hạn"]
        H["<b>procedural/</b><br/>cách làm"]
        SE["<b>personal/</b><br/>về bạn"]
    end
    M ==>|"củng cố — tái xuất hiện,<br/>không mâu thuẫn"| LT
    M -.->|"phai — không nhắc lại"| X(["dọn"])
    M -.->|"tái củng cố — chọi thì<br/>hạ độ tin, giáng hoặc thay"| LT
```
...
## Cấu trúc thư mục
[![GitHub Created At](https://img.shields.io/github/created-at/Won-Cafe/W.O.N)](https://github.com/Won-Cafe/W.O.N)
...
## Riêng tư & Linh hoạt
[![GitHub Issues by label](https://img.shields.io/github/issues/Won-Cafe/W.O.N/private)](https://github.com/Won-Cafe/W.O.N/issues?q=label%3Aprivate)
...
## Còn cái tên?
[![GitHub Repo stars](https://img.shields.io/github/stars/Won-Cafe/W.O.N)](https://github.com/Won-Cafe/W.O.N/stargazers)
...
## Góp nước
[![GitHub Sponsors](https://img.shields.io/github/sponsors/Won-Cafe)](https://github.com/sponsors/Won-Cafe)
...
## Giấy phép
[![GitHub License](https://img.shields.io/github/license/Won-Cafe/W.O.N)](https://github.com/Won-Cafe/W.O.N/blob/main/LICENSE)
...
---
[![GitHub forks](https://img.shields.io/github/forks/Won-Cafe/W.O.N)](https://github.com/Won-Cafe/W.O.N/forks)
